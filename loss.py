...
class AngularMargin(Layer):
    ...
    def build(self, input_shape):
        """定义权重"""
        nb_feats=input_shape[0][-1] if isinstance(input_shape[0],Iterable) else input_shape[-1]
    ...
    def call(self, inputs, mask=None):
        ...
        cos_theta_add_m=cos_theta*math.cos(self.m)-sin_theta*math.sin(self.m)
        #
    ...
    def compute_output_shape(self, input_shape):
        nb_samples=input_shape[0][0] if isinstance(input_shape[0],Iterable) else input_shape[0]
